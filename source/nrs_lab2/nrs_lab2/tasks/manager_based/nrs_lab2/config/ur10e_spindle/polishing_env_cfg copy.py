...
from nrs_lab2.tasks.manager_based.nrs_lab2.ur10e_spindle_env_cfg import UR10eSpindleEnvCfg
from nrs_lab2.assets.robots.ur10e_w_spindle import EE_FRAME_NAME
from nrs_lab2.tasks.manager_based.nrs_lab2 import mdp
...
class PolishingPoseHoldEnvCfg(UR10eSpindleEnvCfg):
    ...
    def __post_init__(self):
        ...
        # (1) 명령어 등록: EE pose command 추가
        self.commands.ee_pose = CommandTermCfg(
            func=mdp.generated_commands,  # reach MDP의 target pose generator
            params={
                "command_name": "ee_pose",
                "body_name": EE_FRAME_NAME,
                "goal_pos": TARGET_POS_XYZ,
                "goal_quat": TARGET_QUAT_WXYZ,
            },
        )
